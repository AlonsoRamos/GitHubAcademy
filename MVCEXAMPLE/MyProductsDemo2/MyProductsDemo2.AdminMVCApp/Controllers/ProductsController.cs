...
using MyProductsDemo2.AdminMVCApp.Models;

namespace MyProductsDemo2.AdminMVCApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,Model,Price,Keywords,CategoryId,Active,CreateDateTime,UpdateDateTime")] Product product)
        {
            if (ModelState.IsValid)
            {
